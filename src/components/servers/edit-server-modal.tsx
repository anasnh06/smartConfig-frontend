  ...
  useEffect(() => {
    if (selectedServer) {
      form.reset({
        ...
        operatingSystemId: selectedServer.operatingSystemId,
        roleIds: selectedServer.roleIds,
        environmentId: selectedServer.environmentId,
        projectId: selectedServer.projectId,
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={closeEditServerModal}>
                Cancel
              </Button>
