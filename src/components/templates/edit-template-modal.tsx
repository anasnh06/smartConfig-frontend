  ...
  useEffect(() => {
    if (selectedTemplate) {
      form.reset({
        ...
        compatibleOsIds: selectedTemplate.compatibleOsIds,
        compatibleRoleIds: selectedTemplate.compatibleRoleIds,
        configurationIds: selectedTemplate.configurationIds,
      })
    }
      ...
      <DialogContent className="sm:max-w-[700px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={closeEditTemplateModal}>
                Cancel
              </Button>
